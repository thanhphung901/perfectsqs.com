...
namespace Controller
{
    public class Product_Details
    {
        ...
        public List<Pro_details_entity> Load_Product_Detail(string _News_seo_url)
        {
            try
            {
                ...
                var list = (from a in db.ESHOP_NEWS_CATs
                            ...
                            select new { b.NEWS_ID, b.NEWS_TITLE,b.NEWS_FIELD1,b.NEWS_FIELD2, b.NEWS_IMAGE3,b.NEWS_PRICE1, b.NEWS_DESC, b.NEWS_SEO_URL, b.NEWS_URL, b.NEWS_ORDER, b.NEWS_ORDER_PERIOD, b.NEWS_PUBLISHDATE,b.NEWS_CODE, c.CAT_SEO_URL }).OrderByDescending(n => n.NEWS_PUBLISHDATE).OrderByDescending(n => n.NEWS_ORDER).ToList();
        ...
        public List<ESHOP_NEWS_IMAGE> Load_albumimgbyId(int _id)
        {
            try
            {
                var list = db.ESHOP_NEWS_IMAGEs.Where(n => n.NEWS_IMG_ID == _id).ToList();
                return list;
            }
            catch (Exception)
            {
