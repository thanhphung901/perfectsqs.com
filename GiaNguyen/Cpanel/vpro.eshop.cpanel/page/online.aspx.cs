...
namespace vpro.eshop.cpanel.page
{
    public partial class online : System.Web.UI.Page
    {
        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    //txtEmail.Value = G_info.ToList()[0].ONLINE_FIELD3;
        ...
        private void SaveInfo(string strLink = "")
        {
            try
            {
                ...
                if (m_online_id == 0)
                {
                    ...
                    //g_insert.ONLINE_FIELD3 = txtEmail.Value;
                ...
                else
                {
                    ...
                    if (g_update.ToList().Count > 0)
                    {
                        ...
                        //g_update.Single().ONLINE_FIELD3 = txtEmail.Value;
        ...
        {
            if (rblType.SelectedValue == "99")
            {
                ihotline.Visible = iSkype.Visible = true;
                iUrl.Visible = true;
            }
            else if (rblType.SelectedValue == "2")
            {
                iSkype.Visible = iUrl.Visible = false;
                ihotline.Visible = true;
            }
            else { ihotline.Visible = iSkype.Visible = false; iUrl.Visible = true; }
