<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="order-contact.aspx.cs" Inherits="vpro.eshop.cpanel.page.order_contact" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Danh sách liên hệ đơn hàng| vpro.eshop</title>
                    ...
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tên khách hàng" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ORDER_EMAIL">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ORDER_USERNAME")%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="Email" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                ...
                                SortExpression="ORDER_EMAIL">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ORDER_EMAIL")%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                                </HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Left"></ItemStyle>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Số điện thoại" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                            ...
                            <asp:TemplateColumn HeaderText="Địa chỉ" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ORDER_ADD">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ORDER_ADD")%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                                </HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Left"></ItemStyle>
                            ...
                            <asp:TemplateColumn HeaderText="Số lượng" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                ...
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ORDER_QUANTITY")%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                                </HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Left"></ItemStyle>
                            ...
                            <asp:TemplateColumn HeaderText="Ngày đặt hàng" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ODER_DATE">
                                <ItemTemplate>
                                    <%# getdate(DataBinder.Eval(Container.DataItem, "ODER_DATE"))%>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                                </HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Left"></ItemStyle>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Ghi chú" HeaderStyle-Width="94%" ItemStyle-Wrap="true"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="ORDER_REMARK">
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container.DataItem, "ORDER_REMARK")%>
                                </ItemTemplate>
