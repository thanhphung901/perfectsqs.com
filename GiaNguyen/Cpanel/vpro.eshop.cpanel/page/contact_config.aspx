...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        tinyMCE.init({
            ...
            mode: "textareas",
            theme: "advanced",
            plugins: "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,template,wordcount,advlist,autosave,visualblocks",
...
<%--        <div class="icon_function_Child">
    ...
    <div id="field" style="display:none;">
     ...
     <div id="field">
        ...
        <table width="auto" border="0">
            <tr>
                <td>
                    <textarea id="Textarea3" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
        </table>
    </div>
    <div id="field" style="display:none;">
        ...
        <table width="auto" border="0">
            <tr>
                <td>
                    <textarea id="Textarea4" cols="20" rows="10" class="mrk1" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
        </table>
    </div>
     <div id="field" style="display:none;">
        ...
        <table width="auto" border="0">
            <tr>
                <td>
                    <textarea id="Textarea1" cols="20" rows="10" class="mrk" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
        </table>
    </div>
    <div id="field" style="display:none;">
        ...
        <table width="auto" border="0">
            <tr>
                <td>
                    <textarea id="Textarea2" cols="20" rows="10" class="mrk1" style="height: 500px;" runat="server"></textarea>
                </td>
            </tr>
        </table>
    </div>
