            ...
            <tr>
                <td colspan="3">
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        Width="60%" DataKeyField="ONLINE_ID" CssClass="tdGridTable" SelectedIndex="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Description" HeaderStyle-Width="94%" ItemStyle-Wrap="False"
                            ...
                            <asp:TemplateColumn HeaderText="Yahoo/URL" HeaderStyle-Width="1%" ItemStyle-Wrap="False" Visible="false"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                            ...
                            <asp:TemplateColumn HeaderText="Skype" HeaderStyle-Width="1%" ItemStyle-Wrap="False" Visible="false"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                            ...
                            <asp:TemplateColumn HeaderText="Hotline" HeaderStyle-Width="1%" ItemStyle-Wrap="False" Visible="false"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                            ...
                            <asp:TemplateColumn HeaderText="#" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "ONLINE_ID")) %>'>Edit
                                    </a>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                                <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
