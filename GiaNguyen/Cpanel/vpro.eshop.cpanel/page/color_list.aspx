<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="color_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.color_list" %>
            ...
            <tr>
                <td colspan="3">
                    <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
                        Width="100%" DataKeyField="COLOR_ID" CssClass="tdGridTable" SelectedIndex="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tên" HeaderStyle-Width="40%" ItemStyle-Wrap="False"
                                ...
                                <ItemTemplate>
                                    <a href='<%# getLink(DataBinder.Eval(Container.DataItem, "COLOR_ID")) %>'>
                            ...
                            <asp:TemplateColumn HeaderText="Activate" HeaderStyle-Width="25%" ItemStyle-Wrap="true"
                                HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                                SortExpression="COLOR_ACTIVE">
                                <ItemTemplate>
                                    <%# getActive(Eval("COLOR_ACTIVE"))%>
                                </ItemTemplate>
